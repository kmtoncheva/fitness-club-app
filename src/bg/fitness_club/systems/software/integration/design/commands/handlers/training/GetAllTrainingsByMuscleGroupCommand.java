...
public class GetAllTrainingsByMuscleGroupCommand extends CommandsValidator implements CommandHandler {
    private final FitnessClubAPI fitnessClub;
    private final String[] args;

    public GetAllTrainingsByMuscleGroupCommand(FitnessClubAPI fitnessClub, String[] args) {
    ...
    public String execute() throws SQLException {
        ...
        return fitnessClub.getAllTrainingsByMuscleGroups(List.of(args));
    }
}
