...
import bg.fitness_club.systems.software.integration.design.commands.validators.CommandsCreatorValidator;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import static bg.fitness_club.systems.software.integration.design.client.Client.getStrings;
