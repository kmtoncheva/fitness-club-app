...
import bg.fitness_club.systems.software.integration.design.commands.handlers.difficulty.GetDifficultyByTrainingNameCommand;
import bg.fitness_club.systems.software.integration.design.commands.handlers.equipment.EquipmentCommandExecutor;
import bg.fitness_club.systems.software.integration.design.commands.handlers.duration.GetDurationForTrainingByNameCommand;
import bg.fitness_club.systems.software.integration.design.commands.handlers.exercise.GetExercisesByTrainingNameCommand;
import bg.fitness_club.systems.software.integration.design.commands.handlers.muscle_group.GetMuscleGroupsByTrainingNameCommand;
import bg.fitness_club.systems.software.integration.design.commands.handlers.training.GetTrainingByNameCommand;
import bg.fitness_club.systems.software.integration.design.commands.handlers.training.TrainingCommandExecutor;
import bg.fitness_club.systems.software.integration.design.commands.validators.CommandExecutorValidator;
